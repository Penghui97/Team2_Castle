...
/**
 * Encrypt algorithm written by Penghui Xiao in 2018
 *
 */
...
public class DESUtil {
    ...
    //构造函数
    public DESUtil(StringBuffer text, StringBuffer key, int mode) throws Exception {
    ...
    public byte[] getCiphertextbyte() throws UnsupportedEncodingException {
        return ciphertext.toString().getBytes(StandardCharsets.UTF_8);
...
//        //测试加密
//
//        StringBuffer text = new StringBuffer("123");
//        StringBuffer key = new StringBuffer("12345678");
//
//        int mode = 0;
...
//
//        //测试解密
//        String text1 = new String(instance.getCiphertextbyte(),"utf-8");
//        text = new StringBuffer(text1);
//        //text = instance.getCiphertext();
//        key = new StringBuffer("12345678");
//        mode = 1;
